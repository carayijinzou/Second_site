...
date: '2019-11-26'
tags: ["Model", "Test","Predict","MANOVA","ANOVA", "Post-hoc","PERMANOVA","Regression", "Bootstrap","ROC","AOC","Confusion Matrix","Cross Validation", "LASSO","Statistics"]
categories: ["Statistics"]
output:
  html_document: default
  pdf_document: default
summary: " Examines the relationship between tuberculosis cases, mortality, resistance, etc. compared to country's GDP, population, etc. Using this data a variety of statistical tests and models are formed for prediction."
---
...
knitr::opts_chunk$set(echo = TRUE, eval = TRUE,fig.align="center",warning=FALSE,message=FALSE,fig.width=8, fig.height=5, linewidth=60, error=FALSE, cache=TRUE)
