...
date: '2019-10-20'
tags: ["Tidyverse", "ggplot2", "Statistics","R"]
categories: ["Statistics"]
output:
  html_document: default
  pdf_document: default
summary: " Visualization of the relationship between tuberculosis cases, mortality, resistance, etc. compared to country's GDP, population, etc. Tidyverse is used for data cleaning while ggplot2 was used for graphing."
---

```{r global_options, include=FALSE}
library(knitr)
options(tinytex.verbose = TRUE)
opts_chunk$set(fig.align="center", fig.height=5, message=FALSE, fig.width=8,tidy.opts=list(width.cutoff=60),tidy=TRUE,error=TRUE, warning=FALSE, cache=TRUE)
```
